      ...
      <div className="container mx-auto px-4">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-8">
              ...
              <p className="text-base text-gray-600 max-w-3xl mx-auto">
                Powered by cutting edge AI-USSD and built specifically to
                include underserved Africa rural insurance market.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              >
                ...
                <p className="text-gray-600 mb-3 text-sm">
                  Submit claims in minutes via app or USSD, get approved in
                  hours. No more weeks of waiting.
                </p>
                <ul className="space-y-1.5">
                  <li className="flex items-start gap-2 text-xs text-gray-700">
              ...
              >
                ...
                <p className="text-gray-600 mb-3 text-sm">
                  Get up to 50% of your claim instantly while your claim payout
                  is being processed.
                </p>
                <ul className="space-y-1.5">
                  <li className="flex items-start gap-2 text-xs text-gray-700">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-gray-700 text-xs">
                            ...
                            ), ending insurer "string along" tactics and
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-gray-700 text-xs">
                            Bridges awareness gaps by informing rural users
                            about their entitlements and how to access them
                            effectively.
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-gray-700 text-xs">
                            Auto-generates shareable testimonials that turn
                            every successful claim into a{" "}
                            <span className="font-bold text-[#00A878]">
                              viral success story
                            </span>
                            , rebuilding insurance companies trust across
                            Africa.
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-gray-700 text-xs">
                            Direct integration with regulatory bodies (NAICOM)
                            for regulatory oversight, ensuring compliance and
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-gray-700 text-xs">
                            White-label solutions for insurers and associations
                            to offer ClaimAm services under their own brand.
                          </p>
                        </div>
                      </div>
                    </div>
            ...
            <div className="max-w-4xl mx-auto text-center">
              ...
              >
                ...
                <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
                  ...
                  any phone — even in the deepest village — and file your claim
                  in minutes or visit any of our ClaimAm agents nation wide.
                </p>
              </motion.div>
              ...
              >
                <p className="text-blue-100 text-lg">
                  serving 600+M Africans, starting with 106M underserved
                  Nigerians in every corner of the country.
                </p>
              </motion.div>
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Get your insurance claim processed in 4 simple steps online or
                via *669# or via any of ClaimAm agent nation wide
              </p>
            </div>
                ...
                <div className="grid grid-cols-2 gap-6">
                  ...
                  >
                    ...
                    <p className="text-gray-600 text-sm">
                      Create your account in under 2 minutes via app or dial
                      *669# from any phone or visit a ClaimAm agent near you.
                    </p>
                  </motion.div>
                  ...
                  >
                    ...
                    <p className="text-gray-600 text-sm">
                      Receive instant approval and get funds directly to your
                      bank account.
                    </p>
                  </motion.div>
                </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              >
                ...
                <p className="text-gray-700 mb-4 text-sm">
                  "Imagine being in my village with no network and dialing
                  *669#, fie my claim via USSD, and get my payout within 12
                  hours, all without leaving the farm, wouldn't that be Epic!"
                </p>
                <div className="flex items-center gap-2">
              ...
              >
                ...
                <p className="text-gray-700 mb-4 text-sm">
                  "We hope ClaimAm processes motor insurance claim in 15
                  minutes! this will turn me to lifetime subscriber when i get
                  my money same day."
                </p>
                <div className="flex items-center gap-2">
              ...
              >
                ...
                <p className="text-gray-700 mb-4 text-sm">
                  "Hope i can get an advance pay to safe me during an emergency
                  up to 40% instantly while they verified my motor claim."
                </p>
                <div className="flex items-center gap-2">
              ...
              >
                <div className="space-y-4">
                  ...
                  <p className="text-sm text-gray-700 leading-relaxed">
                    With one dial{" "}
                    <span className="font-bold text-[#00A878]">(*669#)</span> or
                    a few taps on our app, or with our agents anyone, anywhere,
                    even deep in the village with zero internet, can file a
                    claim, have our AI verify it in seconds, and payout hits in
                    hours.
                  </p>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-xl text-gray-600 mb-8">
                  ...
                  transform your insurance claims process. Works via app or
                  *669#.
                </p>
        ...
        <section className="py-20 bg-gradient-to-r from-[#0052CC] to-blue-700">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
              With our AI-USSD revolution. Dial *669# from any phone, anywhere,
