            ...
            <div className='row align-items-center'>
              <div className='col-xl-5 col-lg-6 wow fadeInLeft'>
                <div className='title-one'>
                  ...
                  <h2>Always online 24/7 customer service support</h2>
                </div>
                <p className='text-lg mt-45 lg-mt-30 mb-35 lg-mb-20'>
                  Your success is our mission. As a business solution, we offer
                  expert services, unlocking your potential for growth and
                  profitability
                </p>
                <div className='d-inline-flex flex-wrap align-items-center'>
                  <Link href='/login' className='btn-four mt-15 me-4'>
                  Join us now
                  </Link>
              ...
              <div className='col-xl-7 col-lg-6 wow fadeInRight'>
                <div className='media-list-item ms-auto pe-xxl-5 pe-4 ps-xxl-5 ps-4 pb-35 md-mt-60 d-flex align-items-end'>
                  <ul className='style-none'>
                    <li>Web, Mobile app for Android and IOS</li>
                    <li>Always online customer service support</li>
                    <li>Robust Transactions / Payment receipts.</li>
                  </ul>
                </div>
              </div>
            </div>
