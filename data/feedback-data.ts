...
export const feedback_one = [
  {
    id:1,
    // user:user_1,
    name:'Ganiyat Ajibade',
    location:'Lagos, Nigeria',
    desc:`"I've been using PayQwicker for over a year now, and it's completely changed the way I manage my finances. With its seamless airtime purchase feature, I no longer have to worry about running out of credit unexpectedly. Plus, the ability to convert airtime to cash has been a lifesaver in emergencies. PayQwicker's convenience and reliability have made it my go-to financial app."`
  },
  {
    id:2,
    // user:user_1,
    ...
    desc:`"As an expatriate living abroad, I rely heavily on international money transfers to support my family back home. PayQwicker has made this process incredibly easy and affordable. Their competitive exchange rates and speedy transactions have saved me both time and money. I highly recommend PayQwicker to anyone looking for a reliable money transfer service"`
  },
  {
    id:3,
    // user:user_1,
    ...
    desc:`"Being a busy professional, I need financial tools that offer both convenience and security. PayQwicker ticks all the boxes for me. Whether it's paying my bills, topping up my phone credit, or sending money to friends, I can do it all from one app, anytime, anywhere. The peace of mind knowing that my transactions are protected by top-notch security measures is priceless. Thank you, PayQwicker, for making my financial life easier!"`
  }
]
// feedback one end
