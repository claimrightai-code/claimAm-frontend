      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-white rounded-[2.5rem] p-8 shadow-2xl shadow-slate-200 border border-slate-100 relative overflow-hidden">
          ...
          <div className="text-center mb-8">
            <h2 className="text-2xl font-bold text-slate-900 mb-2">Activate Dashboard</h2>
            <p className="text-slate-500 text-sm leading-relaxed">
              Hello <span className="font-bold text-slate-800">{user?.full_name}</span>, 
              your profile is ready! Pay your one-time slot fee to start earning commissions.
            </p>
          </div>
          ...
          <div className="bg-slate-50 rounded-2xl p-6 mb-8 border border-slate-100">
            <div className="flex justify-between items-center mb-4">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs font-bold text-slate-400 uppercase tracking-wider">Agent Slot Fee</span>
              </div>
